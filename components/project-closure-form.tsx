...
// Definir el tipo para los pasos del formulario
type FormStep = {
  id: string
  title: string
  icon: React.ReactNode
  condition?: (projectType: string) => boolean
}
...
// Exportar el componente con dynamic import
export default dynamic(() => Promise.resolve(ProjectInitiationForm), {
  ssr: false,
})
